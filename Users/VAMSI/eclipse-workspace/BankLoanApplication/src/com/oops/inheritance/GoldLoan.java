...
public class GoldLoan extends LoanImpl {
	...
	void getLoanDocInfo() {
		System.out.println("***All the Gold Loan Documents are Verifies Successfully***");
	}
	...
	public static void main(String[] args) {
		...
		System.out.println("*****Welcome to Vamsidhar National Bank for Gold Loan Banking*****");
		...
		if (salary >= 800000.00 && age >= 25 && (cibil >= 300 && cibil <= 900)) {
			...
			if (gl.isPhoneValid() && gl.isAadharValid() && gl.isPanValid()) {
				...
				System.out.println("Details are Good and Gold Loan got Approved");
				System.out.println("Your Loan Interest rate is:" + gl.getLoanROI());
			} else {
				System.out.println("Something Went Wrong !!!");
			}
		} else {
			System.out.println("You are Not Eligible for Gold Loan and your loan got Rejected");
		}
	}
