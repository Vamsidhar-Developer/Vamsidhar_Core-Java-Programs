...
public class HomeLoan extends LoanImpl {
	void getLoanDocInfo() {
		System.out.println("***All the Home Loan Documents are Verifies Successfully***");
	}
	...
	public static void main(String[] args) {
		System.out.println("*****Welcome to Vamsidhar National Bank for Home Loan Banking*****");
		...
		if (salary >= 800000.00 && age >= 25 && (cibil >= 300 && cibil <= 900)) {
			...
			if (hl.isPhoneValid() && hl.isAadharValid() && hl.isPanValid()) {
				...
				System.out.println("Your Loan Interest rate is:" + hl.getLoanROI());
			} else {
				System.out.println("Something Went Wrong !!!");
			}
		} else {
			System.out.println("You are Not Eligible for Home Loan and your loan got Rejected");
		}
	}
